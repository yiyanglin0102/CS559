...
import { GrSimpleSwing, GrColoredRoundabout, GrSimpleRoundabout, 
GrAdvancedSwing, GrCarousel, GrTeacups } from "./8-parkobjects.js";
...
function test() {
	...
	let swing_3 = new GrAdvancedSwing({x:10, z:5});
	world.add(swing_3);
	
	let carousel = new GrCarousel({x:-10, z:10});
	world.add(carousel);
	
	let teacups = new GrTeacups({x:-10, z:-10});
	world.add(teacups);
