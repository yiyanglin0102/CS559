...
function test() {
    let mydiv = document.getElementById("6-2");
    ...
    let shaderMat = shaderMaterial("./Shaders/e61-aa-checks.vs","./Shaders/e61-aa-checks.fs",
        {
            side:T.DoubleSide,
            uniforms: {
                checks : {value: 4.0},
    ...
    let s1 = new InputHelpers.LabelSlider("checks",  {width:400,min:1,max:20,step:.5,initial:4,where:mydiv});
